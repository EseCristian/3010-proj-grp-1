...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'md5dff73d9307a165ca92666407070246a1';
CREATE ROLE webuser1;
ALTER ROLE webuser1 WITH NOSUPERUSER INHERIT NOCREATEROLE CREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:fbeq10xTYqs03yL1ACJakQ==$hhqX2m30dkC1o6FR5JL/j6MmC9pwI0TMpJYyRZR4YhE=:mDOnjGFZA9oe9UTPkcp0qD3Gfwcb9OlzIganZQI26ig=';
...
CREATE DATABASE project_db WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.UTF-8';
...
CREATE TABLE public.committee_names (
    id integer NOT NULL,
    committee_name character varying(300),
...
--
-- Name: course_director; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.course_director (
...
ALTER TABLE public.course_director OWNER TO postgres;
...
CREATE TABLE public.course_schedule (
    ...
    begintime character varying(10),
...
CREATE TABLE public.faculty (
    ...
    research character varying(1000),
    rank character varying(50),
    remarks character varying(200),
    currently_employed character varying(50)
);
...
CREATE TABLE public.prerequisites (
    ...
    number integer,
    pcprefix character varying(100),
    pcnumber character varying(50),
    pccode character varying(50)
);
...
--
-- Data for Name: course_director; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.course_director (prefix, number, coursedirectorid, remarks) FROM stdin;
CSCI	1000	14	\N
CSCI	1003	14	\N
CSCI	1010	14	\N
CSCI	1011	14	\N
...
COPY public.course_schedule (year, semester, prefix, number, section, crn, enrollment, instructor, days, begintime, endtime, remarks) FROM stdin;
2021	Spring	CSCI	1010	1	31764	49	14	 MWF	0900	0950	\N
...
2021	Spring	CSCI	2530	1	31895	27	9	TR	0930	1045	\N
2021	Spring	CSCI	2530	2	32985	50	9	TR	1230	1345	\N
2021	Spring	CSCI	2540	1	31897	15	4	TR	0930	1045	\N
...
2021	Spring	CSCI	6010	1	31932	4	7	TR	0930	1045	\N
...
2020	Fall	CSCI	3700	1	84091	22	4	TR	0930	1145	\N
...
2020	Fall	SENG	2010	1	84189	6	15	TR	0930	1145	\N
...
2020	Fall	SENG	6245	1	84088	5	3	TR	0930	1045	\N
...
2020	Fall	CSCI	1011	1	84105	19	14	M	0900	1040	\N
2020	Fall	CSCI	1011	2	84106	22	14	M	1100	1240	\N
2020	Fall	CSCI	1011	3	84107	20	14	W	0900	1040	\N
2020	Fall	CSCI	1011	4	84108	20	14	W	1100	1240	\N
2020	Fall	CSCI	1011	5	86696	14	14	T	0900	1040	\N
2020	Fall	CSCI	2400	1	84054	36	1	MWF	0900	0950	\N
...
2020	Fall	SENG	1010	1	84077	10	1	MWF	0900	0950	\N
...
2020	Spring	CSCI	2540	1	35511	12	4	TR	0930	1045	\N
2020	Spring	CSCI	2540	2	35513	30	4	TR	1230	1345	\N
2020	Spring	CSCI	3000	1	35442	11	12	MWF	0900	0950	\N
...
2020	Spring	CSCI	3650	1	35436	45	13	MWF	0900	0950	\N
...
2020	Spring	CSCI	4710	1	35606	50	16	TR	0930	1045	\N
...
2020	Spring	SENG	1010	1	35678	11	19	TR	0930	1045	\N
2020	Spring	SENG	1020	1	35681	4	14	MW	1530	1645	\N
2020	Spring	SENG	6240	1	35658	2	15	TR	0930	1045	\N
...
2019	Fall	CSCI	1011	4	84058	18	14	T	0900	1040	\N
2019	Fall	CSCI	1011	5	84083	16	14	T	1100	1240	\N
2019	Fall	CSCI	2400	1	84128	41	12	TR	0930	1045	\N
2019	Fall	CSCI	2400	2	84129	40	12	TR	1530	1645	\N
2019	Fall	CSCI	2405	1	84136	29	13	MWF	0900	0950	\N
2019	Fall	CSCI	2405	2	84159	35	16	TR	0930	1045	\N
...
2019	Fall	CSCI	3030	1	84108	30	8	TR	0930	1045	\N
...
2019	Fall	CSCI	3700	2	83786	29	4	TR	0930	1045	\N
...
2019	Fall	CSCI	4602	2	83698	35	1	MWF	0900	0950	\N
...
2019	Fall	SENG	6235	1	84148	5	15	TR	0930	1045	\N
...
2019	Spring	CSCI	2540	1	32852	25	4	TR	0930	1045	\N
2019	Spring	CSCI	2540	2	32853	16	4	TR	1230	1345	\N
2019	Spring	CSCI	3000	1	32869	15	12	MWF	0900	0950	\N
2019	Spring	CSCI	3000	2	32872	41	12	MWF	1100	1150	\N
2019	Spring	CSCI	3000	3	33021	13	12	TR	0930	1045	\N
...
2019	Spring	CSCI	4140	1	33027	26	13	MWF	0900	0950	\N
...
2018	Fall	CSCI	2400	1	85595	66	13	MWF	0900	0950	\N
...
2018	Fall	CSCI	2410	1	84648	60	10	TR	0800	0915	\N
...
2018	Fall	CSCI	3030	1	84659	49	8	TR	0930	1045	\N
2018	Fall	CSCI	3030	2	86797	20	8	TR	1530	1645	\N
2018	Fall	CSCI	3200	1	85596	7	4	TR	0900	1040	\N
...
2018	Fall	SENG	6250	1	85714	3	12	TR	0930	1045	\N
...
2018	Spring	CSCI	1011	4	32223	19	9	W	0800	0950	\N
2018	Spring	CSCI	1011	5	32224	17	9	F	0800	0950	\N
...
2018	Spring	CSCI	2540	1	32228	36	4	TR	0930	1045	\N
...
2018	Spring	CSCI	4140	1	32241	25	13	MWF	0900	0950	\N
2018	Spring	CSCI	4230	1	32235	31	12	TR	0900	1040	\N
2018	Spring	CSCI	4231	1	32237	31	12	TR	0900	1040	\N
...
2018	Spring	CSCI	6905	2	32327	9	15	TR	0930	1045	\N
...
2017	Fall	CSCI	2410	1	85533	78	10	TR	0930	1045	\N
...
2017	Fall	CSCI	3584	1	85531	47	5	MWF	0900	0950	\N
...
2017	Fall	CSCI	4520	1	85547	36	13	MWF	0900	0950	\N
2017	Fall	CSCI	4540	1	85460	10	8	TR	0930	1045	\N
2017	Fall	CSCI	4602	1	85532	29	5	MWF	1100	1150	\N
2017	Fall	CSCI	4627	1	85882	1	1	\N	\N	\N	\N
2017	Fall	CSCI	6905	1	85472	16	8	TR	0930	1045	\N
...
2017	Fall	SENG	6250	1	85540	1	22	TR	0930	1045	\N
...
2017	Spring	CSCI	3200	1	34232	19	10	TR	0930	1045	\N
...
2017	Spring	CSCI	4140	1	34339	15	13	MWF	0900	0950	\N
2017	Spring	CSCI	4160	1	34349	5	5	MW 	1530	1645	\N
2017	Spring	CSCI	4170	1	34927	9	12	TR	0930	1045	\N
2017	Spring	CSCI	4230	1	34241	41	22	TR	1100	1250	\N
2017	Spring	CSCI	4231	1	34242	37	22	TR	1700	1800	\N
2017	Spring	CSCI	4550	1	34234	13	26	TR	0930	1045	\N
...
2016	Fall	CSCI	2400	1	86707	50	27	TR	0800	0915	\N
...
2016	Fall	CSCI	3550	1	85747	26	26	MWF	0900	0950	\N
...
2016	Fall	CSCI	4520	1	85791	18	13	MWF	0900	0950	\N
...
2016	Spring	CSCI	2310	1	35295	92	6	MWF	0900	0950	\N
...
2016	Spring	CSCI	2410	1	36378	28	10	MWF	0900	0950	\N
2016	Spring	CSCI	2427	1	35291	56	5	MWF	1000	1050	\N
2016	Spring	CSCI	3200	1	35377	24	13	MTWF	0900	0950	\N
...
2016	Spring	CSCI	3800	1	35340	13	26	MWF	0900	0950	\N
...
2016	Spring	CSCI	5503	1	36926	1	21	\N	0800	0850	\N
...
2016	Spring	SENG	6260	1	35395	8	15	TR	0930	1045	\N
...
2015	Fall	CSCI	1001	2	82946	22	25	TR	0930	1045	\N
2015	Fall	CSCI	2310	1	82949	38	6	TR	0930	1045	\N
...
2015	Fall	CSCI	3300	1	83071	33	1	MTWF	0900	0950	\N
...
2015	Fall	CSCI	4200	1	83090	15	8	TR	0930	1045	\N
...
2015	Fall	CSCI	4520	1	83100	12	13	MWF	0900	0950	\N
...
COPY public.courses (prefix, number, title, description, gu, ch, frequency, remarks, active) FROM stdin;
...
COPY public.faculty (id, honorific, first_name, middle_initial, last_name, email, phone, office, research, rank, remarks, currently_employed) FROM stdin;
...
COPY public.prerequisites (prefix, number, pcprefix, pcnumber, pccode) FROM stdin;
CSCI	1000	 MATH	 1065	 PC
CSCI	1000	 CSCI	 1003	 C
CSCI	1010	 SAT	 ACT	 P
SAT/ACT or MATH 1065 or CSCI 1000	\N	 C: CSCI 1011.	\N	 
\.
...
--
-- Name: committee_assignments committee_assignments_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.committee_assignments
    ADD CONSTRAINT committee_assignments_pkey PRIMARY KEY (faculty_id, committee_id);
...
--
-- Name: course_director course_director_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.course_director
    ADD CONSTRAINT course_director_pkey PRIMARY KEY (prefix, number);
...
ALTER TABLE ONLY public.course_schedule
    ADD CONSTRAINT course_schedule_pkey PRIMARY KEY (year, semester, prefix, number, section, instructor);
...
--
-- Name: committee_assignments committee_assignments_committee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.committee_assignments
    ADD CONSTRAINT committee_assignments_committee_id_fkey FOREIGN KEY (committee_id) REFERENCES public.committee_names(id);


--
-- Name: committee_assignments committee_assignments_faculty_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.committee_assignments
    ADD CONSTRAINT committee_assignments_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.faculty(id);


--
-- Name: course_director course_director_coursedirectorid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.course_director
    ADD CONSTRAINT course_director_coursedirectorid_fkey FOREIGN KEY (coursedirectorid) REFERENCES public.faculty(id);


--
-- Name: course_schedule course_schedule_instructor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.course_schedule
    ADD CONSTRAINT course_schedule_instructor_fkey FOREIGN KEY (instructor) REFERENCES public.faculty(id);
...
GRANT USAGE ON SCHEMA public TO webuser1;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.committee_assignments TO webuser1;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.committee_names TO webuser1;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.contacts TO webuser1;


--
-- Name: TABLE course_director; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.course_director TO webuser1;


--
-- Name: TABLE course_schedule; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.course_schedule TO webuser1;
...
GRANT ALL ON TABLE public.courses TO webuser1;
...
--
-- Name: TABLE prerequisites; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.prerequisites TO webuser1;
